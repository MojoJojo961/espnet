...
set noxtics
set noytics
set title 'DET plot for exp/seed_five_percent_pytorch_train_seed_model_five_percent_ctc_b32/decode_test_decode_ctc/hyp.trn'
set nokey
...
plot [-3.290527:3.290527] [-3.290527:3.290527] \
 "exp/seed_five_percent_pytorch_train_seed_model_five_percent_ctc_b32/decode_test_decode_ctc/hyp.trn.det.dat.00" using 2:1 title "exp/seed_five_percent_pytorch_train_seed_model_five_percent_ctc_b32/decode_test_decode_ctc/hyp.trn" with lines 1
set ytics
set xtics
set size 1.0, 1.0
set key
