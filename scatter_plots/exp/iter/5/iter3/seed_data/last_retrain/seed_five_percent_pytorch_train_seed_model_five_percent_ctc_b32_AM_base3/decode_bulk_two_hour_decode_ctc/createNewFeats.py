...
#    writeNewFeats(seed_b1_b2_b3_b4_b5, dir_name, 'bin1_bin2_bin3_bin4_bin5_n_seed_on_phone_from_seed_retrain')
    ...
    writeNewFeats(b[0], dir_name, 'bin1_on_phone')
    writeNewFeats(b[1], dir_name, 'bin2_on_phone')
    writeNewFeats(b[2], dir_name, 'bin3_on_phone')
    writeNewFeats(b[3], dir_name, 'bin4_on_phone')
    writeNewFeats(b[4], dir_name, 'bin5_on_phone')
