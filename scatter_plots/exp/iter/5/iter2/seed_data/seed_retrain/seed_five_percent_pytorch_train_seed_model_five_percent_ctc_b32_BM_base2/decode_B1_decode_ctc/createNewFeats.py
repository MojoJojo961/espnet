...
def createBinJson(feat_dir_name, dir_name):
    ...
    with open(feat_dir_name+'/bin1P_n_seed_on_phone.json', 'r') as f:
...
#    seed_b1_b2 = {**seed_b1, **b}
    ...
    writeNewFeats(seed_b1, dir_name, 'bin1P2_n_seed_on_phone')
    writeNewFeats(b, dir_name, 'bin1P2_on_phone')
