...
#         f.write(json.dumps({'utts': new_feats}, indent=4, ensure_ascii=False, sort_keys=True).encode('utf-8'))
    writeNewFeats(seed_b1, dir_name, 'bin1_n_seed_on_phone')
    writeNewFeats(seed_b1_b2, dir_name, 'bin2_n_seed_on_phone')
    writeNewFeats(seed_b1_b2_b3, dir_name, 'bin3_n_seed_on_phone')
    writeNewFeats(seed_b1_b2_b3_b4, dir_name, 'bin4_n_seed_on_phone')
    writeNewFeats(seed_b1_b2_b3_b4_b5, dir_name, 'bin5_n_seed_on_phone')
