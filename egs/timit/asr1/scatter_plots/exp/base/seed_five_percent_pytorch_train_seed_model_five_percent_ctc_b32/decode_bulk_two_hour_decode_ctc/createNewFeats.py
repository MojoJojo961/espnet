...
def createBinJson(feat_dir_name, dir_name):
    ...
    seed_b1_b2 = {**orig_feats, **b[1]}
    seed_b1_b2_b3 = {**orig_feats, **b[2]}
    seed_b1_b2_b3_b4 = {**orig_feats, **b[3]}
    seed_b1_b2_b3_b4_b5 = {**orig_feats, **b[4]}
...
#         f.write(json.dumps({'utts': new_feats}, indent=4, ensure_ascii=False, sort_keys=True).encode('utf-8'))
    writeNewFeats(seed_b1, dir_name, 'bin1_on_phone')
    writeNewFeats(seed_b1_b2, dir_name, 'bin2_on_phone')
    writeNewFeats(seed_b1_b2_b3, dir_name, 'bin3_on_phone')
    writeNewFeats(seed_b1_b2_b3_b4, dir_name, 'bin4_on_phone')
    writeNewFeats(seed_b1_b2_b3_b4_b5, dir_name, 'bin5_on_phone')
