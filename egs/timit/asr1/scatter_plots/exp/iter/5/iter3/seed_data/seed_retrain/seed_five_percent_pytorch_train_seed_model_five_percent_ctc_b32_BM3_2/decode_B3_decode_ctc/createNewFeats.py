...
def createBinJson(feat_dir_name, dir_name):
    ...
    with open(feat_dir_name+'/bin1_bin2_bin3P_n_seed_on_phone_from_seed_retrain.json', 'r') as f:
...
#    seed_b1_b2 = {**seed_b1, **b}
    ...
    writeNewFeats(seed_b1, dir_name, 'bin1_bin2_bin3P2_n_seed_on_phone_from_seed_retrain')
    writeNewFeats(b, dir_name, 'bin3P2_on_phone')
